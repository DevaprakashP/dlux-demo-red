...
const PlatformsHover = () => {
  return (
    <div className='platform'>
      <div className='platformLeft'><FaGripLinesVertical style={{color:"red",height:"11%",display:""}}/>
        Platforms <br/>
        <br />
        Have a look at the technology platforms we excel at. <span><br /></span>
        <span style={{color:"rgb(138,43,226)"}}><a href="" style={{textDecorationLine:"none",fontSize:"16px",color:"red"}}>VIEW  ALL  PLATFORMS </a>
        <FaLongArrowAltRight style={{color:"red"}}/></span>
      </div>
