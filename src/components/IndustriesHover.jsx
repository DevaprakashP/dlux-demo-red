...
const IndustriesHover = () => {
    return (
        <div className='platform'>
          <div className='platformLeft'><FaGripLinesVertical style={{color:"red",height:"11%"}}/>
            Industries <span><br /></span>Check out the industries we provide our services for.<span><br /></span>
            <span><a href="" style={{textDecorationLine:"none",fontSize:"16px",color:"red"}}>VIEW  ALL  INDUSTRIES </a>
